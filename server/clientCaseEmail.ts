...
function intakeEmailPreheader(caseId: string): string {
  const safe = escapeHtml(caseId);
  return `<div style="display:none;max-height:0;max-width:0;overflow:hidden;opacity:0;visibility:hidden;font-size:1px;line-height:1px;color:#eef2f7;">We received your intake form. Reference ${safe}. Open your client portal to track status.</div>`;
}
