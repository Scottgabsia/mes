  ...
  return (
    <section className="mb-stack-lg">
      <div className="flex items-end justify-between mb-8">
        <div>
          <h3 className="text-3xl font-bold text-white tracking-tight uppercase">Global Reputation & Sentiment</h3>
          <p className="text-slate-500 font-fira text-xs mt-2 uppercase tracking-widest font-semibold font-fira">// VERIFIED_EXT_PLATFORMS</p>
        </div>
